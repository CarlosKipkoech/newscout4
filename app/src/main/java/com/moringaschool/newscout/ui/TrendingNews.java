...
public class TrendingNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<NewsBusinessesSearchResponse> call = client.getArticles("bitcoin");
        ...
        call.enqueue(new Callback<NewsBusinessesSearchResponse>() {
            ...
            public void onResponse(Call<NewsBusinessesSearchResponse> call, Response<NewsBusinessesSearchResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    NewsAdapter newsAdapter = new NewsAdapter(articles, TrendingNews.this); //pass mNews and activity
                    recyclerView.setAdapter(newsAdapter);
                    recyclerView.setLayoutManager(new LinearLayoutManager(TrendingNews.this));   // set layout manager as the current context
