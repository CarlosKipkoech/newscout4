...
public class TechonologyNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_techonology_news);
        ButterKnife.bind(this);


        NewsApi client = NewsClient.getClient();
        Call<NewsBusinessesSearchResponse> call = client.getArticles("technology");
        ...
        call.enqueue(new Callback<NewsBusinessesSearchResponse>() {
            ...
            public void onResponse(Call<NewsBusinessesSearchResponse> call, Response<NewsBusinessesSearchResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    NewsAdapter newsAdapter = new NewsAdapter(articles, TechonologyNews.this); //pass mNews and activity
                    recyclerView.setAdapter(newsAdapter);
                    recyclerView.setLayoutManager(new LinearLayoutManager(TechonologyNews.this));   // set layout manager as the current context
        ...
        ImageViewNotesBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TechonologyNews.this, MyNotes.class);
