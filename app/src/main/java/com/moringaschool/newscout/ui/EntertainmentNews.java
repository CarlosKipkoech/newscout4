...
public class EntertainmentNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<NewsBusinessesSearchResponse> call = client.getArticles("Entertainment");
        ...
        call.enqueue(new Callback<NewsBusinessesSearchResponse>() {
            ...
            public void onResponse(Call<NewsBusinessesSearchResponse> call, Response<NewsBusinessesSearchResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    NewsAdapter newsAdapter = new NewsAdapter(articles, EntertainmentNews.this); //pass mNews and activity
                    recyclerView.setAdapter(newsAdapter);
                    recyclerView.setLayoutManager(new LinearLayoutManager(EntertainmentNews.this));   // set layout manager as the current context
        ...
        ImageViewNotesBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EntertainmentNews.this, MyNotes.class);
